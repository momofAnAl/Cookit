...
const {seed} = require('./seeders/20240303194223-users.js')
...
// DEV
app.post('./seeders/20240303194223-users.js', seed)
...
app.listen(SERVER_PORTPORT, () => console.info(`app running on ${SERVER_PORT}`));